  ...
  return (
    <div className="flex flex-col w-64 bg-slate-800 text-white">
      ...
      <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        {/* Fix: Corrected typo 'comunicação' to 'comunicacao' to match the ProfessorView type definition. */}
        <NavLink icon={<svg xmlns="http://www.w3.org/2000/svg" className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>} label="Comunicação" isActive={activeView === 'comunicacao'} onClick={() => handleLinkClick('comunicacao')} />
